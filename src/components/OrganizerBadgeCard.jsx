 ...
 * - Organizer Details, Gate, Role, and Wave Footer Banner
 */
export default function OrganizerBadgeCard({
  ...
  return (
    ...
    >
      ...
      {/* ========================================================================= */}
      {/* ========================================================================= */}
      {/* OFFICIAL NOTICE & MOTTO (التعليمات والشعار) */}
      {/* ========================================================================= */}
      <div className="relative z-10 px-3 text-center my-auto space-y-2">
        <p className="text-[9.5px] sm:text-[10.5px] text-slate-700 leading-relaxed font-medium max-w-[320px] mx-auto tracking-normal">
        ...
        <div className="pt-0.5">
          ...
          <div className="flex justify-center mt-1">
            <WingFlourish className="w-24 h-2.5 text-[#162a5c]" />
          </div>
        </div>

        {/* Slogan Badge */}
        <div className="pt-1">
          <div className="inline-flex flex-col items-center justify-center px-4 py-1.5 bg-white/95 rounded-xl border border-slate-200/90 shadow-sm">
            <span className="text-xs sm:text-sm font-black text-[#162a5c] leading-tight">
              تعليم يصنع الفرص
            </span>
            <span className="text-[7px] font-bold text-slate-500 uppercase tracking-wider font-sans mt-0.5">
              EDUCATION CREATES OPPORTUNITIES
            </span>
            <div className="w-8 h-[2px] bg-gradient-to-r from-emerald-400 to-teal-600 rounded-full mx-auto mt-1"></div>
          </div>
        </div>
      </div>
