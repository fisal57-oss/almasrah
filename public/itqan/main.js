...
function createWindow() {
    ...
    // Allow and configure popup windows for digital form and theater modules
...
ipcMain.handle('backup-project', async () => {
    return new Promise((resolve) => {
        ...
        // PowerShell command to zip core files including theater module
        const cmd = `powershell -Command "Compress-Archive -Path '${path.join(__dirname, 'app.js')}', '${path.join(__dirname, 'index.html')}', '${path.join(__dirname, 'style.css')}', '${path.join(__dirname, 'main.js')}', '${path.join(__dirname, 'package.json')}', '${path.join(__dirname, 'assets')}', '${path.join(__dirname, 'theater')}' -DestinationPath '${zipPath}' -Force"`;
